...
export default class Player {
    ...
    playerColor(playerNumber, opacity) {
        switch (playerNumber) {
            case 0:
    ...
    checkFinish() {
        if (this.position[1] >= this.canvas.height - this.canvas.height / 4 - 50 &&
            ...
            else if (this.position[0] >= this.canvas.width / 2 + 30 &&
    ...
    checkCollision() {
        ...
        if (this.position[0] < this.canvas.width / 4) {
            let distance = Math.sqrt(Math.pow(this.position[0] - this.canvas.width / 4, 2) +
        ...
        if (this.position[0] >= this.canvas.width / 4 &&
            ...
            if (this.position[1] > this.canvas.height / 2 - 50 &&
